    ...
    <div class="row">
      <div class="col-12 col-md-6 bsb-tpl-bg-platinum">
        <div class="d-flex flex-column justify-content-between h-100 p-3 p-md-4 p-xl-5">
          ...
          <p class="mb-0">Henüz üye değil misin?<a href="/kayitol" class="link-secondary text-decoration-none">Kayıt Ol</a></p>
        </div>
      </div>
        ...
        <div class="p-3 p-md-4 p-xl-5">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="text-end">
                <a href="#!" class="link-secondary text-decoration-none">Şifremi unuttum</a>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-12">
              <p class="mt-5 mb-4">Veya şununla oturum açın:</p>
...
export default {
  ...
  methods: {
    async login() {
  try {
    const response = await axios.post('http://127.0.0.1:8000/api/admin/giris', {
      email: this.email,
    ...
    if (role === 'admin') {
      ...
      this.$router.push(`/user/panel/${id}`);
      console.log(token);
